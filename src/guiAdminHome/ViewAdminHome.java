...
public class ViewAdminHome {
    ...
    */
    ...
    private ViewAdminHome() {
        ...
        for (int i = 0; i < roles.length; i++) list.add(roles[i]);
        ...
        // === NEW: View Requests Button ===
        setupButtonUI(button_ViewRequests, "Dialog", 16, 250, Pos.CENTER, 300, 290);
        button_ViewRequests.setOnAction((_) -> {
            ControllerAdminHome.performViewRequests();
        });
