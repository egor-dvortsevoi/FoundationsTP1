...
/**
 * Finite-state-machine based recognizer for validating usernames.
 */
public class UserNameRecognizer {
	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
						...
						{	// removed check for 0-9 to make only alphabetic valid for 1st character
					nextState = 1;
		...
		userNameRecognizerErrorMessage = ""; // Made empty to improve formatting in GUI
